...
import com.example.service.qa.service.userinfo.SysRoleMenuService;
...
//        List<CrmClearUser> sysUserEntityList = sysUserService.list();
...
//        map.put("sysMenuEntityList",sysMenuEntityList);
    ...
    public Map<String,Object> getInfoAll(){
        Map<String,Object> map = new HashMap<>();
        CrmClearUser user = new CrmClearUser();
        user.setUsername("a");
        CrmClearUser sysUserEntityList = sysUserService.queryClearUser(user);
        map.put("sysUserEntityList",sysUserEntityList);
//        List<SysRoleEntity> sysRoleEntityList = sysRoleService.list();
//        map.put("sysRoleEntityList",sysRoleEntityList);
//        List<SysMenuEntity> sysMenuEntityList = sysMenuService.list();
