...
//@Configuration  去掉shrio框架，需要的时候再打开
...
//        filterChainDefinitionMap.put("/userLogin/**", "anon");
        //上线数据修改不需要被拦截
//        filterChainDefinitionMap.put("/modifyData/**", "anon");
        //三方会员授权不需要被拦截
//        filterChainDefinitionMap.put("/trdmember/**", "anon");
//        filterChainDefinitionMap.put("/**", "authc");
        filterChainDefinitionMap.put("/**", "anon");
        Map<String, Filter> filterMap = shiroFilterFactoryBean.getFilters();
        filterMap.put("authc", new TokenCheckFilter());
    ...
    public RedisManager redisManager() {
        ...
        String hostAndPort = String.format("{}:{}", host, port);
